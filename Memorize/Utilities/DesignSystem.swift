/*
 * Design System
 * Unified design system - colors, typography, styles
 */
...
struct AppColors {
    ...
    static let memorizeBackground = Color(hex: "FBF7F0")
    static let memorizeCard = Color(hex: "1F2420")
    static let memorizeAccent = Color(hex: "BFEFC8")
