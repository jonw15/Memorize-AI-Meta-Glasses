/*
 * Records View
 * Records page - Contains tabs for various record types
 */
        ...
        ZStack {
            ...
            if viewModel.conversations.isEmpty {
                ...
                VStack(spacing: AppSpacing.lg) {
                    ...
                    Text("No Live AI conversation records")
                        .font(AppTypography.title2)
                        .foregroundColor(AppColors.textPrimary)

                    Text("Records will appear here after using Live AI")
                        .font(AppTypography.subheadline)
...
class ConversationListViewModel: ObservableObject {
    ...
    func loadConversations() {
        ...
        print("📱 [RecordsView] Loaded conversations: \(conversations.count) items")
    }
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: AppSpacing.lg) {
                ...
                Text("No calorie recognition records")
                    .font(AppTypography.title2)
                    .foregroundColor(AppColors.textPrimary)
