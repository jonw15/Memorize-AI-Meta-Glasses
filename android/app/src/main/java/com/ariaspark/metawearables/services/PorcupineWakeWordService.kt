...
class PorcupineWakeWordService : Service() {
    ...
    companion object {
        ...
        const val ACTION_WAKE_WORD_DETECTED = "com.ariaspark.metawearables.WAKE_WORD_DETECTED"
        const val EXTRA_KEYWORD_INDEX = "keyword_index"

        // Service control actions
        const val ACTION_START = "com.ariaspark.metawearables.START_WAKE_WORD"
        const val ACTION_STOP = "com.ariaspark.metawearables.STOP_WAKE_WORD"
