package com.ariaspark.metawearables.utils
...
class APIKeyManager(context: Context) {
    ...
    companion object {
        ...
        private const val PREFS_NAME = "aria_secure_prefs"
...
enum class StreamQuality(val id: String, val displayNameResId: Int, val descriptionResId: Int) {
    LOW("LOW", com.ariaspark.metawearables.R.string.quality_low, com.ariaspark.metawearables.R.string.quality_low_desc),
    MEDIUM("MEDIUM", com.ariaspark.metawearables.R.string.quality_medium, com.ariaspark.metawearables.R.string.quality_medium_desc),
    HIGH("HIGH", com.ariaspark.metawearables.R.string.quality_high, com.ariaspark.metawearables.R.string.quality_high_desc)
}
